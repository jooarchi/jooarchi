          ...
          <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-8">
              ...
              {settings.aboutPhilosophyText && (
                <div className="text-gray-600 font-light leading-relaxed whitespace-pre-line text-lg">
                  {settings.aboutPhilosophyText}
                </div>
              )}
            </div>
            ...
            <div className="md:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-16">
              ...
              {(settings.aboutPrincipalName || settings.aboutPrincipalTitle || settings.aboutPrincipalEducation || settings.aboutPrincipalCareer || settings.aboutPrincipalAwards) && (
                <div>
                  ...
                  />
                  {settings.aboutPrincipalName && <h3 className="display-font text-3xl font-medium mb-2">{settings.aboutPrincipalName}</h3>}
                  {settings.aboutPrincipalTitle && <p className="text-sm uppercase tracking-widest text-gray-400 mb-8">{settings.aboutPrincipalTitle}</p>}
                  ...
                  <div className="space-y-6 text-sm font-light text-gray-300">
                    {settings.aboutPrincipalEducation && (
                      <div>
                        ...
                        <p className="whitespace-pre-line">{settings.aboutPrincipalEducation}</p>
                      </div>
                    )}
                    {settings.aboutPrincipalCareer && (
                      <div>
                        <h4 className="text-white font-medium mb-2">Career</h4>
                        <p className="whitespace-pre-line">{settings.aboutPrincipalCareer}</p>
                      </div>
                    )}
                    {settings.aboutPrincipalAwards && (
                      <div>
                        <h4 className="text-white font-medium mb-2">Awards</h4>
                        <p className="whitespace-pre-line">{settings.aboutPrincipalAwards}</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="flex flex-col justify-center">
                  {settings.aboutStudioInfo && (
                    <div className="mb-16">
                      ...
                      <div className="text-sm font-light text-gray-300 whitespace-pre-line leading-loose">
                        {settings.aboutStudioInfo}
                      </div>
                    </div>
                  )}
                  ...
                  {settings.aboutClientsText && (
                    <div>
                      ...
                      <div className="text-sm font-light text-gray-300 whitespace-pre-line">
                        {settings.aboutClientsText}
                      </div>
                    </div>
                  )}
